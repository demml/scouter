# pylint: disable=dangerous-default-value,redefined-builtin,missing-param-doc,invalid-name
...
class GenAIEvalResults:
    ...
    def as_table(self, show_tasks: bool) -> str:
        """Pretty print the workflow or task results as a table

        Args:
            show_tasks (bool):
                Whether to show individual task results or just the workflow summary.
        """
