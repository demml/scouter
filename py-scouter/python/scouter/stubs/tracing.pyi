...
class ActiveSpan:
    ...
    def add_event(self, name: str, attributes: SerializedType, timestamp: Optional[int] = None,) -> None:
    ...
    def record_exception(self, exception: Exception, attributes: Optional[Dict[str, SerializedType]] = None, timestamp: Optional[int] = None, escaped: bool = False) -> None:
