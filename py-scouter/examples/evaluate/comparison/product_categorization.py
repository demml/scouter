...
def create_baseline_dataset() -> EvalDataset:
    ...
    tasks = [
        AssertionTask(
            id="correct_category",
            context_path="prediction.category",
        ...
        AssertionTask(
            id="high_confidence",
            context_path="prediction.confidence",
        ...
        AssertionTask(
            id="fast_processing",
            context_path="prediction.processing_time_ms",
        ...
        AssertionTask(
            ...
            context_path="prediction.feature_count",
            operator=ComparisonOperator.GreaterThanOrEqual,
            expected_value=6,
        ...
        AssertionTask(
            id="has_keywords",
            context_path="prediction.matched_keywords",
