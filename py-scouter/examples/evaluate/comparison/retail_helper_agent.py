...
def create_evaluation_tasks() -> List[LLMJudgeTask | AssertionTask]:
    ...
    return [
        ...
        AssertionTask(
            ...
            context_path="agent_response.provides_solution",
            operator=ComparisonOperator.Equals,
            expected_value=True,
        ...
        AssertionTask(
            ...
            context_path="agent_response.acknowledges_concern",
            operator=ComparisonOperator.Equals,
            expected_value=True,
