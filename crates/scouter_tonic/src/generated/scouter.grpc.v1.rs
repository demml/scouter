...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct RegisterScenariosRequest {
    #[prost(string, tag = "1")]
    pub collection_id: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    pub scenarios_json: ::prost::alloc::string::String,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct RegisterScenariosResponse {
    #[prost(string, tag = "1")]
    pub status: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    pub collection_id: ::prost::alloc::string::String,
...
/// Generated client implementations.
pub mod eval_scenario_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct EvalScenarioServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl EvalScenarioServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> EvalScenarioServiceClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> EvalScenarioServiceClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            EvalScenarioServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn register_scenarios(
            &mut self,
            request: impl tonic::IntoRequest<super::RegisterScenariosRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RegisterScenariosResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/scouter.grpc.v1.EvalScenarioService/RegisterScenarios",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "scouter.grpc.v1.EvalScenarioService",
                        "RegisterScenarios",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
/// Generated server implementations.
pub mod eval_scenario_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with EvalScenarioServiceServer.
    #[async_trait]
    pub trait EvalScenarioService: std::marker::Send + std::marker::Sync + 'static {
        async fn register_scenarios(
            &self,
            request: tonic::Request<super::RegisterScenariosRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RegisterScenariosResponse>,
            tonic::Status,
        >;
    ...
    #[derive(Debug)]
    pub struct EvalScenarioServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> EvalScenarioServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for EvalScenarioServiceServer<T>
    where
        T: EvalScenarioService,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::Body>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/scouter.grpc.v1.EvalScenarioService/RegisterScenarios" => {
                    #[allow(non_camel_case_types)]
                    struct RegisterScenariosSvc<T: EvalScenarioService>(pub Arc<T>);
                    impl<
                        T: EvalScenarioService,
                    > tonic::server::UnaryService<super::RegisterScenariosRequest>
                    for RegisterScenariosSvc<T> {
                        type Response = super::RegisterScenariosResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as EvalScenarioService>::register_scenarios(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RegisterScenariosSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for EvalScenarioServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "scouter.grpc.v1.EvalScenarioService";
    impl<T> tonic::server::NamedService for EvalScenarioServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
