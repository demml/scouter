...
impl PsiDrifter {
            ...
            profiles_to_monitor
                ...
                .map(|profile| {
                    let proportion_pairs =
                        self.get_feature_bin_proportion_pairs(profile, &observed_bin_proportions);
    ...
    /// # Returns
    ///
    fn organize_alerts(&self, mut alerts: HashMap<String, f64>) -> Vec<BTreeMap<String, String>> {
