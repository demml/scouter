...
#[openapi(
    ...
    paths(
        ...
        // genai
        crate::api::routes::trace::genai::get_token_metrics,
        crate::api::routes::trace::genai::get_operation_breakdown,
        crate::api::routes::trace::genai::get_model_usage,
        crate::api::routes::trace::genai::get_agent_activity,
        crate::api::routes::trace::genai::get_tool_activity,
        crate::api::routes::trace::genai::get_error_breakdown,
        crate::api::routes::trace::genai::get_genai_spans,
        ...
        crate::api::routes::trace::genai::get_genai_dashboard,
        // service map
    ...
    components(schemas(
        ...
        // genai
        scouter_types::trace::genai::GenAiMetricsRequest,
        scouter_types::trace::genai::GenAiSpanFilters,
        scouter_types::trace::genai::GenAiTokenBucket,
        scouter_types::trace::genai::GenAiTokenMetricsResponse,
        scouter_types::trace::genai::GenAiOperationBreakdown,
        scouter_types::trace::genai::GenAiOperationBreakdownResponse,
        scouter_types::trace::genai::GenAiModelUsage,
        scouter_types::trace::genai::GenAiModelUsageResponse,
        scouter_types::trace::genai::GenAiAgentActivity,
        scouter_types::trace::genai::GenAiAgentActivityResponse,
        scouter_types::trace::genai::GenAiToolActivity,
        scouter_types::trace::genai::GenAiToolActivityResponse,
        scouter_types::trace::genai::GenAiErrorCount,
        scouter_types::trace::genai::GenAiErrorBreakdownResponse,
        scouter_types::trace::genai::GenAiEvalResult,
        scouter_types::trace::genai::GenAiSpanRecord,
        scouter_types::trace::genai::GenAiSpansResponse,
        scouter_types::trace::TraceId,
        scouter_types::trace::SpanId,
        scouter_types::trace::genai::ModelPricing,
        scouter_types::trace::genai::AgentDashboardRequest,
        scouter_types::trace::genai::AgentMetricBucket,
        scouter_types::trace::genai::ModelCostBreakdown,
        scouter_types::trace::genai::AgentDashboardSummary,
        scouter_types::trace::genai::AgentDashboardResponse,
        ...
        scouter_types::trace::genai::GenAiDashboardRequest,
        scouter_types::trace::genai::GenAiDashboardResponse,
        scouter_types::trace::genai::AppliedFilters,
        scouter_types::trace::genai::AvailableFilters,
        scouter_types::trace::genai::DashboardMetadata,
    )),
    tags(
        ...
        (name = "genai", description = "GenAI semantics observability endpoints"),
    ),
