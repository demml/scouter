...
.PHONY: test.server
test.server:
	cargo test -p scouter-server test_profile_versions --all-features -- --nocapture --test-threads=1 --skip test_storage_integration_cloud --skip test_data_archive_llm
