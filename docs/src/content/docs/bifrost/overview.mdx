...
description: "See how Bifrost reads and writes structured Scouter data."
---
...
- [Quickstart](/scouter/bifrost/quickstart/) -- end-to-end write and read example
- [Writing Data](/scouter/bifrost/writing-data/) -- `DatasetProducer` configuration and patterns
- [Reading Data](/scouter/bifrost/reading-data/) -- `DatasetClient`, SQL queries, format conversions
- [Schema Reference](/scouter/bifrost/schema/) -- `TableConfig`, type mapping, fingerprinting
