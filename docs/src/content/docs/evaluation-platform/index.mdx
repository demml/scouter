...
> For usage guide and quick start, see [Agent evaluation](/agents/overview/).
...
For a detailed feature-by-feature comparison, see [Platform comparison](/evaluation-platform/comparison/).
...
- [Building blocks: eval profiles and task types](/evaluation-platform/eval-profiles-and-tasks/)
- [Offline evaluation architecture](/evaluation-platform/offline-evaluation/)
- [Online evaluation architecture](/evaluation-platform/online-evaluation/)
- [Observability engine and trace-based evaluation](/evaluation-platform/observability-and-traces/)
- [Trade-offs and operational considerations](/evaluation-platform/discussion-and-tradeoffs/)
