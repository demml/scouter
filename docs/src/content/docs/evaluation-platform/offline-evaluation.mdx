...
For the complete usage guide with code examples, see [Offline evaluation](/agents/offline-evaluation/).

> For how these building blocks (task types, DAGs, operators) work, see [Building blocks](/evaluation-platform/eval-profiles-and-tasks/).
...
For details, see [EvalDataset](/agents/eval-dataset/).
