...
This page covers the primitives and how they fit together. For full API reference with code examples, see [Evaluation tasks](/agents/tasks/).

> For the problem this solves, see the [evaluation platform overview](/evaluation-platform/).
...
For the full operator reference, see [Evaluation tasks](/agents/tasks/).
...
For detailed gate usage with code examples, see [Conditional gates](/agents/gates/).
...
The rest of this technical overview covers how these building blocks execute in [offline evaluation](/evaluation-platform/offline-evaluation/) and [online evaluation](/evaluation-platform/online-evaluation/).
