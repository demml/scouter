---
title: "Scouter gRPC"
description: "Design notes for the gRPC transport and service shape."
---
## Overview
...
Grpc is typically used when (1) exporting spans to Scouter server for tracing, or (2) sending monitoring data (features, metrics, agent evaluation records) to the Scouter server. To facilitate this, we have exposed one main classes to the Python layer via PyO3:
